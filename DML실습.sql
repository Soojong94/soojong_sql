...
ACT_POINT, 
PHONE_NO)
        VALUES ( 'NICE123' ,  '나이스' ,'12345', SYSDATE ,'N' , '0 ', 'N', '0' , '010-1111-2222');
...
SELECT C.CUST_ID , B.BADGE_ID
 FROM TB_CUST C INNER JOIN TB_CUST_BADGE B
...
/*
4. 2023년을 맞이해 새로운 이벤트를 진행하려고 합니다. 
...
/* 
7.  TB_DEAL 테이블의 모든 데이터를 삭제해주세요.  (DELETE 로 삭제)
*/ 
